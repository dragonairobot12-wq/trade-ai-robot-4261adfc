...
const Footer = () => {
  ...
  return <footer className="relative overflow-hidden border-t border-border/50">
      {/* Background Effects */}
          ...
          once: true
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                ...formData,
                name: e.target.value
              })} required className="glass-card border-border/50 focus:border-primary bg-secondary/50" />
              </div>
              <div>
              ...
              })} required rows={4} className="glass-card border-border/50 focus:border-primary bg-secondary/50 resize-none" />
              </div>
              <Button type="submit" disabled={isSubmitting} className="w-full gradient-primary text-primary-foreground shadow-glow hover:shadow-glow-orange transition-all">
            ...
            <div className="grid grid-cols-3 gap-6 md:gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {["Home", "Products", "Investors", "Team", "FAQ", "Contact"].map(link => <li key={link}>
                      <Link to={`/${link.toLowerCase() === "home" ? "" : link.toLowerCase() === "products" ? "packages" : link.toLowerCase()}`} className="text-sm text-muted-foreground hover:text-primary transition-colors">
                        {link}
                      </Link>
                    </li>)}
                </ul>
              ...
              <div>
                ...
                <div className="flex flex-col gap-3">
                  <a href="https://t.me/dragon_ai_robot" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-[#0088cc] transition-colors group">
                  ...
                  <a href="https://twitter.com/dragon_ai_robot" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors group">
                    <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                    </svg>
                    Twitter (X)
                  </a>
                  <a href="https://discord.gg/dragonai" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-[#5865F2] transition-colors group">
                    <svg className="w-5 h-5 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
