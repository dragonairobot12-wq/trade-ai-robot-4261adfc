        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <a 
                href="#" 
                className="w-12 h-12 rounded-xl glass-card-glow flex items-center justify-center text-2xl hover:shadow-glow transition-all group"
                title="Telegram"
              >
              ...
              <a 
                href="#" 
                className="w-12 h-12 rounded-xl glass-card flex items-center justify-center text-2xl hover:shadow-glow transition-all group"
                title="Twitter"
              >
